...
from parser.models import BiaffineDependencyModel
...
from parser.utils.field import Field, SubwordField, BertField
...
class BiaffineDependencyParser(Parser):
    ...
    def predict(self, data, pred=None, buckets=8, batch_size=5000,
        ...
        Returns:
            A :class:`~parser.utils.Dataset` object that stores the predicted results.
        """

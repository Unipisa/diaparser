...
from parser.utils import Config, Dataset
from parser.utils.field import Field, BertField
...
class Parser():
    ...
    def load(cls, path, **kwargs):
        ...
        Args:
            path (str):
                - a string with the shortcut name of a pretrained parser defined in ``parser.PRETRAINED``
        ...
        if os.path.exists(path):
            ...
            path = parser.PRETRAINED[path] if path in parser.PRETRAINED else path
